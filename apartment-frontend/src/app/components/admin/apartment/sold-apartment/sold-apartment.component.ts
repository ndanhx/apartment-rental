...
@Component({
  selector: 'app-sold-apartment',
  templateUrl: './sold-apartment.component.html',
  styleUrls: ['./sold-apartment.component.css'],
})
export class SoldApartmentComponent implements OnInit {
