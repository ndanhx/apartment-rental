...
@Component({
  selector: 'app-pending-apartment',
  templateUrl: './pending-apartment.component.html',
  styleUrls: ['./pending-apartment.component.css'],
})
export class PendingApartmentComponent implements OnInit {
