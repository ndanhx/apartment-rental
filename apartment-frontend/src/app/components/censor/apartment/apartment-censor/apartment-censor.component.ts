...
@Component({
  selector: 'app-apartment-censor',
  templateUrl: './apartment-censor.component.html',
  styleUrls: ['./apartment-censor.component.css'],
})
export class ApartmentCensorComponent implements OnInit {
